...
echo python -m pyzap.cli config.azienda.agricola-documenti.json run --iterations 1 --repeat-interval 180
cd /d "%~dp0"
...
python -m pyzap.cli config.azienda.agricola-documenti.json run --iterations 1 --repeat-interval 180
